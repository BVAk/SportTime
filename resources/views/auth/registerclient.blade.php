            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-md-7 mb-5">
                        ...
                        <div class="panel panel-default">
                            <h5 class="control-label">Учасник клубу</h5>
                            <div class="panel-body">
                                <form class="form-horizontal" method="POST" action="{{ route('loginclient') }}">
                                    {{ csrf_field() }}
                                   
                                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                        <label for="card" class="subtitle">Номер картки</label>
                                        <input id="card" type="text" class="form-control" name="card" value="{{ old('card') }}" required autofocus>
                                    </div>

...
class AdminController extends Controller
{
    ...
    public function editprofileYacht($Yachts_id)
    {
     $this->middleware('auth:admin');
     $yachts = DB::table('yachts')->where('Yachts_id','=',$Yachts_id)->get();
$marinas=DB::table('marinas')->get();
        return view('admin.categories.editProfileYacht')->with('Yachts_id',$Yachts_id)->with('yachts',$yachts)->with('marinas',$marinas);
    }
    ...
    public function editprofile(Request $request)
    {
       ...
       'Yacht_price'=>$Yacht_price,'Yacht_owner_name'=>$Yacht_owner_name,'Yacht_date_contract'=>$Yacht_date_contract,'Yacht_about'=>$Yacht_about,'Yacht_type'=>$Yacht_type  );
        ...
        return redirect('/admin')->with('message','Яхта добавлена!');
    }
    ...
    public function deleteYacht(Request $request)
    {
        ...
        $up = array('Booking_status'=>"отменено");
    DB::table('booking')->where('Yachts_Yachts_id','=',$Yachts_id)->update($up);
    DB::table('yachts')->where('Yachts_id','=',$Yachts_id)->delete();
        return redirect('/admin/editYacht')->with('message','Яхта удалeна!');
    }

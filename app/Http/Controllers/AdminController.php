...
class AdminController extends Controller
{
    ...
    public function profileClients(User $id)
    {
        ...
        $userabonnement = DB::table('usersabonnements')->join('abonnements','abonnements.id','=','usersabonnements.abonnement_id')->where('usersabonnements.user_id', '=', $id->id)->where('usersabonnements.end','>=', new \DateTime('now'))->orwhere('usersabonnements.amount','>',0)->get();

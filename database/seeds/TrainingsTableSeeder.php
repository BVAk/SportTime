...
class TrainingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        \Illuminate\Support\Facades\DB::table('trainings')->insert([
            ...
            ['name' => 'Карате', 'description' => "Японське бойове мистецтво, система захисту і нападу.", 'type' => 'дитячі'],
            ['name' => 'Танці', 'description' => "Ритмічні, виразні рухи тіла, зазвичай вибудовуються в певну композицію і виконувані з музичним супроводом.", 'type' => 'дитячі'],
            ['name' => 'Рукопашний бій', 'description' => "Раціональне застосування грубої фізичної сили з використанням спеціальних прийомів боротьби, ударної техніки.", 'type' => 'дитячі']]);
    }
}
